  ...
  it('should display the correct gas price on the transaction', async function () {
    await withFixtures(
      ...
      async ({ driver }) => {
        ...
        await driver.clickElement({ text: '🌐Site suggested', tag: 'button' });
        await driver.waitForSelector({
        ...
        const maxFeeInput = await driver.findElements(
          '[data-testid="base-fee-input"',
        );
        await maxFeeInput.fill('20');
        await driver.waitForSelector({
          text: '0.0042 ETH',
        });
        await driver.clickElement({ text: 'Save', tag: 'button' });
        await driver.waitForSelector({
          css: '.gas-details-item__currency-container',
          text: '0.0042 ETH',
        });
        await driver.clickElement({ text: 'Confirm', tag: 'button' });
